...
struct LogListCreatedByStation {
...
inline void to_json(nlohmann::json& j, const LogListCreatedByStation& v) {
    j = nlohmann::json::object();
    j["id"] = v.id;
    j["name"] = v.name;
}

inline void from_json(const nlohmann::json& j, LogListCreatedByStation& v) {
    if (!j.contains("id")) {
