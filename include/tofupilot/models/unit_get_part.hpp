...
struct UnitGetPart {
    ...
    UnitGetRevision revision;
};

inline void to_json(nlohmann::json& j, const UnitGetPart& v) {
...
inline void from_json(const nlohmann::json& j, UnitGetPart& v) {
    if (!j.contains("id")) {
    ...
    v.revision = j["revision"].get<UnitGetRevision>();
}
