...
inline void to_json(nlohmann::json& j, const RunGetCreatedByUser& v) {
...
inline void from_json(const nlohmann::json& j, RunGetCreatedByUser& v) {
    if (!j.contains("id")) {
...
class RunGetCreatedByUserBuilder {
public:
    /// Set the `id` field.
    /// User ID.
    RunGetCreatedByUserBuilder& id(std::string value) {
        id_ = std::move(value);
        return *this;
    }
    ...
    RunGetCreatedByUser build() const& {
        RunGetCreatedByUser result;
        if (!id_.has_value()) {
