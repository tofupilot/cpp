...
inline void to_json(nlohmann::json& j, const LogListCreatedByUser& v) {
...
inline void from_json(const nlohmann::json& j, LogListCreatedByUser& v) {
    if (!j.contains("id")) {
...
class LogListCreatedByUserBuilder {
public:
    /// Set the `id` field.
    /// Unique identifier for the user.
    LogListCreatedByUserBuilder& id(std::string value) {
        id_ = std::move(value);
        return *this;
    }
    ...
    /// Set the `name` field.
    /// Display name of the user who created this log.
    LogListCreatedByUserBuilder& name(std::string value) {
    ...
    /// Set the `email` field.
    /// Email of the user.
    LogListCreatedByUserBuilder& email(std::string value) {
        email_ = std::move(value);
        return *this;
    }

    /// Build the struct. Throws std::runtime_error if required fields are missing.
    LogListCreatedByUser build() const& {
        LogListCreatedByUser result;
        if (!id_.has_value()) {
