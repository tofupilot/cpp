...
inline void to_json(nlohmann::json& j, const PartGetRevisionCreatedByStation& v) {
    j = nlohmann::json::object();
    j["id"] = v.id;
    j["name"] = v.name;
}

inline void from_json(const nlohmann::json& j, PartGetRevisionCreatedByStation& v) {
    if (!j.contains("id")) {
