...
struct UnitCreateAttachmentResponse {
...
inline void to_json(nlohmann::json& j, const UnitCreateAttachmentResponse& v) {
    j = nlohmann::json::object();
    j["id"] = v.id;
    j["upload_url"] = v.upload_url;
}

inline void from_json(const nlohmann::json& j, UnitCreateAttachmentResponse& v) {
    if (!j.contains("id")) {
