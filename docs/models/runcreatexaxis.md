...
| `validators` | `NullableField<std::vector<RunCreateValidators>>` | :heavy_minus_sign: | Validators for this specific axis/series. |
| `aggregations` | `NullableField<std::vector<RunCreateAggregations>>` | :heavy_minus_sign: | Aggregations computed over this axis data (min, max, avg, etc.). |
