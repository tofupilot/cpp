...
| `validators` | `NullableField<std::vector<MeasurementGetAggregationsValidators>>` | :heavy_minus_sign: | Validators applied to the aggregated value. |
