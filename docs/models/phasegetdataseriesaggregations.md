# PhaseGetDataSeriesAggregations
...
| `validators` | `NullableField<std::vector<PhaseGetDataSeriesAggregationsValidators>>` | :heavy_minus_sign: | Validators applied to the aggregated value. |
