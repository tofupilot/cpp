...
| `message` | `std::string` | :heavy_check_mark: | The log message content. |
| `created_at` | `std::string` | :heavy_check_mark: | ISO 8601 timestamp when the log was created. |
| `source_file` | `std::optional<std::string>` | :heavy_minus_sign: | Source file where the log originated. |
| `line_number` | `std::optional<int64_t>` | :heavy_minus_sign: | Line number in the source file. |
