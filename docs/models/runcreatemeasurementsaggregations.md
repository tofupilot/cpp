...
| `outcome` | `NullableField<ValidatorsOutcome>` | :heavy_minus_sign: | Computed result of aggregation validation. Server stores as-is. |
...
| `validators` | `NullableField<std::vector<RunCreateMeasurementsAggregationsValidators>>` | :heavy_minus_sign: | Validators applied to the aggregated value. |
